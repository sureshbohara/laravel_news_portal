          ...
          <div class="row">
            ...
            <div class="col-12">
              <div class="card mb-4">
                ...
                <div class="row">
                  <div class="col-md-6">
                      <strong>News / Rrchive News List</strong>
                  </div>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                                ...
                                <img src="{{url('images/news/small/',$value['feature_image']) }}" alt="{{$value['name']}}" width="50px;" height="50px;">
